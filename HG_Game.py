...
# Player player
PLAYER_SPACE_SHIP = pygame.image.load('image/ship_player.png').convert_alpha()
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Click here to begin...", 1, (255,255,255))
